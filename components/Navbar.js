      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            <img src='logo.png' className='w-full h-full object-cover ' ></img>
            </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {categories.map((category) => (
              <Link
                ...
                className="text-gray-600 hover:text-[#0E949A] hover:text-blue-600 transition-colors duration-200"
              >
                {category.name}
              </Link>
            ))}
          ...
          <form onSubmit={handleSearch} className="hidden md:flex items-center space-x-2 flex-1 max-w-md mx-8">
            ...
            <Button type="submit" size="sm" className='hover:bg-[#0E949A] bg-[#0E948A] text-white'>
              Search
            </Button>
          </form>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <form onSubmit={handleSearch} className="mb-4">
              ...
              <Button type="submit" size="sm" className="w-full hover:bg-[#0E949A] bg-[#0E948A] text-white">
                Search
              </Button>
            </form>
